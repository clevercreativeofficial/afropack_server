    ...
    <main class="flex-1 overflow-y-auto p-6">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?= $url ?>admin/" class="bg-white p-6 text-left border border-transparent hover:border-accent duration-300 group">
                ...
                <a href="<?= $url ?>admin/news/" class="bg-white p-6 text-left border border-transparent hover:border-accent duration-300 group">
                    ...
                    <p class="font-medium text-gray-900">Manage News Article</p>
                ...
                <a href="<?= $url ?>admin/videos/" class="bg-white p-6 text-left border border-transparent hover:border-accent duration-300 group">
                    ...
                    <p class="font-medium text-gray-900">Manage Video</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <a href="<?= $url ?>admin/subscribers/" class="bg-white p-6 text-left border border-transparent hover:border-accent duration-300 group">
            ...
            <a href="<?= $url ?>admin/settings/" class="bg-white p-6 text-left border border-transparent hover:border-accent duration-300 group">
